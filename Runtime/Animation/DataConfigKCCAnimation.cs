...
namespace GalaxyGourd.KCC
{
	...
	/// Taken from Unity Character Controller Sample project
	/// </summary>
	[CreateAssetMenu(
		fileName = "DAT_KCC_AnimationConfig", 
		menuName = "GG/Characters/KCC Animation Configuration")]
	public class DataConfigKCCAnimation : ScriptableObject
	{
		[Header("New")]
		[SerializeField] public float MaxWalkSpeed;
		[SerializeField] public Vector2 WalkAnimSpeedRange;
		[SerializeField] public Vector2 JogAnimSpeedRange;
		[SerializeField] public float SprintAnimSpeed;

		[SerializeField] public float ForwardSpeedSmoothLerpRate = 12;
		[SerializeField] public float TurningSpeedSmoothLerpRate = 10;
